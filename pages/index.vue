...
const infos: { title: string; description: string; url: string; newTab?: boolean; date: string; pin?: boolean }[] = (() => {
  if (data.value) {
...
const pinnedInfos = infos.filter((info) => info.pin);
</script>
...
<template>
  ...
  <section class="bg-gray-100">
    <div class="mx-auto max-w-4xl px-4 py-10 sm:px-8">
      <div class="mb-10 text-center text-gray-800">
        <h1 class="text-xl font-bold">放送部について</h1>
      </div>
      <div class="mb-10 text-center">
        <h2 class="mb-10 text-3xl leading-relaxed text-red-700">
